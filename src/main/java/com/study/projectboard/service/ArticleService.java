...
public class ArticleService {
    ...
    public Page<ArticleDto> searchArticles(SearchType searchType, String searchKeyword, Pageable pageable) {
       if (searchKeyword==null||searchKeyword.isBlank()){
         return articleRepository.findAll(pageable).map(articles-> ArticleDto.from(articles));
       }
    ...
    public void updateArticle(ArticleDto dto) {
        ...
        try{
            ...
            log.warn("게시글 업데이트 실패. 게시글을 찾지 못했습니다 - dto: {}.",dto);
        }
    }
    ...
    public List<String> getHashtgs() {
        return articleRepository.findByAllDistinctHashtags();
    }
}
