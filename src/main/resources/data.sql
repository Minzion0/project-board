...
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at,
                          modified_by)
values ('minzino', 'asdf1234', 'Uno', 'minzino@mail.com', 'I am Uno.', now(), 'minzino', now(), 'minzino')
;
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at,
                          modified_by)
values ('minzino2', 'asdf1234', 'Uno2', 'minzino2@mail.com', 'I am Uno2.', now(), 'minzino2', now(), 'minzino2')
;
